...
def letter_stat(our_str):
    ...
    в котором ключ - символ строки, значение - количество вхождений этого символа в строку.

    :param our_str: принимает строку.
    :return: возвращает
    """
    letters_dict = {item: our_str.count(item) for item in our_str[0:len(our_str)]}
    return letters_dict
